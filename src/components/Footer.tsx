  ...
  <footer className="bg-foreground text-background py-12">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <div className="flex justify-center gap-4 mb-6">
        {[
          { icon: Instagram, href: "https://instagram.com/timelessmoments.in" },
          { icon: Facebook, href: "https://facebook.com/timelessmoments" },
        ].map((s, i) => (
          <a
            key={i}
            href={s.href}
      ...
      <p className="text-background/60 text-sm mb-2">
        © {new Date().getFullYear()} Timeless Moments Photo Studio. All rights reserved.
      </p>
